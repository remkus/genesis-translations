...
class ThemeMix_Genesis_Translations_i18n {
	...
	public function promo() {
		...
		if ( $message ) {
			echo '<br /><br />';
			echo '<div id="i18n_promo_box" style="border:1px solid red;background-color:#fff;padding:10px;max-width:650px;">';
